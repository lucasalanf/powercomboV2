<div class="row planos">
        ...
        <div class="container">
            ...
            <div class="boxPlanos col-lg-3 col-md-3 col-sm-12">
                <div class="backCinza">
                <div class="boxHeader">
                    <h4>VIVO Ultra HD</h4>
                    <span>+</span>
                    <h4>50 Mega</h4>
                    <span>+</span>
                    <h4 class="telefonia">Vivo Ilimitado Fixo e Móvel Local</h4>

                    <div class="alinhaBotao"><a class="btn assineagora" href="#modal">Consulte agora</a></div>
                </div>

                <div class="boxCaixaTV">
                    ...
                    <ul class="controle">
                        <li><strong>12</strong> Canais Filmes e Séries</li>
                        <li><strong>+ de 2</strong> Canais de Esportes</li>
                        <li><strong>10</strong> Canais Infantis</li>                    
                    </ul>
                </div><!--boxCaixaTV-->

                <div class="boxCaixaTV boxCaixaInternet">
                ...
                <div class="boxCaixaTV boxCaixaTelefones">
                ...
                <div class="backCinza">
                    ...
                    <div class="boxCaixaTV">
                        ...
                        <ul class="controle maisItens">
                            <li><strong>16</strong> Canais Filmes e Séries</li>
                            <li><strong>11</strong> Canais de Esportes</li>
                            <li><strong>11</strong> Canais Infantis</li>
                            <li><strong>7</strong> Canais Internacionais</li>
                        </ul>
                    </div><!--boxCaixaTV-->
            ...
            <div class="boxPlanos col-lg-3 col-md-3 col-sm-12">
                <div class="backCinza">
                    ...
                    <div class="alinhaBotao"><a class="btn" href="#modal">Consulte agora</a></div>
                </div>
            </div><!--boxPlanos-->
