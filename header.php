...
<head>
   ...
   <?php include 'titulosDescricoes.php' ?>
    ...
    <link rel="icon" type="image/png" href="/img/favicon/apple-touch-icon.png" sizes="32x32">
    <link rel="icon" type="image/png" href="/img/favicon/apple-touch-icon.png" sizes="16x16">
